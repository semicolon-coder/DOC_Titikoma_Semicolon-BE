...
const { getCategory, addOrder, getOrderById, getOrderByOrderId, getAllProduct, getProductById, getProductByProductId, getPromo, getTestimonial, getAllTestimonial } = require('./controller');
